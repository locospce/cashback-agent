...
_SEGMENT_FOCUS = {
    "new":      "акцент на первой покупке у партнёра и приветственном кэшбеке",
    "existing": "акцент на лояльности, вознаграждении постоянных клиентов",
    "both":     "нейтральный текст, подходящий для любой аудитории",
}

SYSTEM_PROMPT = (
    "Ты копирайтер банковских кэшбек-кампаний. "
    "Пиши живо и конкретно: указывай процент и сумму кэшбека. "
...
if __name__ == "__main__":
    ...
    raw_ok = json.dumps({
        ...
        "banner": "Получите 15% кэшбека на первую покупку у партнёра. Максимум 4 500 руб.",
        "sms":    "Альфа-Банк: кэшбек 15% на первую покупку у партнёра. Лимит 4 500 руб. Совершите покупку до конца месяца.",
    }, ensure_ascii=False)
